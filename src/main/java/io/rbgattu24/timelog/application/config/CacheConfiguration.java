package io.rbgattu24.timelog.application.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("TimelogSampleApplication");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("TimelogSampleApplication");
        ...
        config.getMapConfigs().put("io.rbgattu24.timelog.application.domain.*", initializeDomainMapConfig(jHipsterProperties));
